...
namespace WASP.DataClasses.UnitTests
{
...

    {
        ...
        {
            Policy pol = new Policy(-1, (Policy.PostDeletePolicy)1, TimeSpan.FromTicks(1000), true, TimeSpan.FromTicks(100), 10);
        ...
        {
            Policy pol1 = new Policy(-1, (Policy.PostDeletePolicy)1, TimeSpan.FromTicks(1000), true, TimeSpan.FromTicks(100), 10);
            pol1 = dal.CreatePolicy(pol1);
            pol1 = dal.GetPolicy(pol1.Id);
            Policy pol2 = new Policy(-1, (Policy.PostDeletePolicy)6, TimeSpan.FromTicks(10000), true, TimeSpan.FromTicks(1000), 100);
        ...
        {
            Policy pol = dal.CreatePolicy(new Policy(-1, (Policy.PostDeletePolicy)2, TimeSpan.FromTicks(1000), true, TimeSpan.FromTicks(100), 10));
            pol = dal.UpdatePolicy(new Policy(pol.Id, (Policy.PostDeletePolicy)1, TimeSpan.FromTicks(9), false, TimeSpan.FromTicks(8), 6));
